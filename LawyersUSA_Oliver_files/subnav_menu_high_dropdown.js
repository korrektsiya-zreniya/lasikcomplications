...
function FW_showMenu(menu, x, y, child) {
	...
	if (document.layers) {
		...
		var l = menu.menuLayer || menu;	
		hideActiveMenus();
		if (menu.hideSelects) hideSelects();
		if (typeof(l) == "string") {
			l = FIND(l);
		}
		window.ActiveMenu = l;
...
//find all selects.
//find the ones with class eq hideondhtml
//turn em all off
//	for (i=0; i < document.all.length; i++) {
//		if (document.all[i].className == 'hideondhtml') {
//		document.all[i].style.visibility = "hidden";
//		}
//	}
	if (!document.layers) {
		for (i=0; i < document.getElementsByTagName("select").length; i++) {
			if (document.getElementsByTagName("select").item(i).className == 'hideondhtml') {
...
//turn em all on
	if (!document.layers) {
		for (i=0; i < document.getElementsByTagName("select").length; i++) {
			if (document.getElementsByTagName("select").item(i).className == 'hideondhtml') {
				document.getElementsByTagName("select").item(i).style.visibility = "inherit";
			}
		}
	}
}
